...
FunctionContext* FunctionContextImpl::CreateContext(RuntimeState* state,
  ...
  ctx->impl_->functions_.ai_generate_text = impala::AiFunctions::AiGenerateTextDummy;
...
FunctionContext::FunctionContext()
  : impl_(new FunctionContextImpl(this)) {}
...
// AI functions
/*(StringVal BuiltInFunctions::ai_generate_text(const StringVal& prompt) const {
  return impala::AiFunctions::AiGenerateText(context_, prompt);
}

StringVal BuiltInFunctions::ai_generate_text(const StringVal& endpoint,
    const StringVal& prompt, const StringVal& model,
    const StringVal& api_key_jceks_secret, const StringVal& params) const {
  return impala::AiFunctions::AiGenerateText(
      context_, endpoint, prompt, model, api_key_jceks_secret, params);
}*/
